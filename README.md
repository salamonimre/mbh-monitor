...
- Egy GitHub repo, ami 5 percenként lekéri a Downdetector adatot
- Telegram értesítés, ha a bejelentett hibák száma átlépi a 30-at
...
A workflow `*/5 * * * *`-vel van ütemezve, de a GitHub ingyenes cron **pár perces késéssel** szokott indulni. Nézd meg 10-15 perc múlva az Actions fület, hogy van-e ott új futás magától.
...
A Downdetector néha szűri a bot trafficot. Megoldás az Operator-ral: User-Agent cserélgetés, vagy ritkább lekérdezés (pl. 10 percenkénti). Ha rendszeresen blokkol: ezzel a projekttel ennyit lehet, át kellene térni fizetős API-ra.
